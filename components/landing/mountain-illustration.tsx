...
export function MountainIllustration({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <polygon points="497,197 525,165 555,200 538,192 512,198" fill="var(--fg)" opacity="0.22" />
      <polygon points="505,192 525,168 546,194 525,188" fill="#ffffff" opacity="0.75" />
    </svg>
  );
}
